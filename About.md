...
The heavy lifting is done by these "Constructor" functions:
```
/*
...
Objects are then built and collected into an array, 'REFS':
...
The objects are then swapped around as needed and their properties are accessed programatically using JQuery.


---


The version controlled js files can be found here:

[ca\_defs.js](http://code.google.com/p/parameterz-coronaries/source/browse/trunk/js/ca_defs.js)

[ca\_main.js](http://code.google.com/p/parameterz-coronaries/source/browse/trunk/js/ca_main.js)